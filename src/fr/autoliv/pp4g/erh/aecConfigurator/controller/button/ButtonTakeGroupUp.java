...
public class ButtonTakeGroupUp extends ModelButton {
	 ...
	 * @param mainFrame
	 */
	public ButtonTakeGroupUp(MainFrame mainFrame){
		super(ConstantIcon.IC_TAKE_GROUP_UP,NativeKeyEvent.VC_UP,true,ModelButton.BUTTON_ICON,ConstantString.TOOL_TIP_BUTTON_TAKE_GROUP_UP);
