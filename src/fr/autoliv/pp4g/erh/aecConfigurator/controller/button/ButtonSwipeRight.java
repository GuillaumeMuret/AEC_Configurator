...
@details
	Button use to switch the AEC attribute with the next
 */
...
public class ButtonSwipeRight extends ModelButton{
	 ...
	 * @param mainFrame
	 */
	public ButtonSwipeRight(MainFrame mainFrame){
		super(ConstantIcon.IC_SWIPE_RIGHT,NativeKeyEvent.VC_O,true,ModelButton.BUTTON_ICON,ConstantString.TOOL_TIP_BUTTON_SWIPE_RIGHT);
		this.mainFrame = mainFrame;
	}
	
	/**
	 * Process called when the user want to change the AEC attribute order (down in the typedef)
	 */
	@Override
