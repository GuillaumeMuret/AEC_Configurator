...
public class ButtonAddGroup extends ModelButton {
	 ...
	 * @param mainFrame
	 */
	public ButtonAddGroup(MainFrame mainFrame){
		super(ConstantIcon.IC_ADD_GROUP,NativeKeyEvent.VC_N,true,ModelButton.BUTTON_ICON,ConstantString.TOOL_TIP_BUTTON_ADD_GROUP);
	...
	public void buttonEvent(){
		if(this.mainFrame.getFrameState()==MainFrame.STATE_MANAGE_GROUP){
			DialogStore.getInstance().getPanelDialogSetAECgroup().addAECgroup();
		}
	}
}
