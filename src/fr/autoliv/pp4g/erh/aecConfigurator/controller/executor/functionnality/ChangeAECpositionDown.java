...
@details
	An action of the command pattern : change the AEC position down in the list
 */
...
public class ChangeAECpositionDown implements ICommand{
	...
	public void execute() {
		try{
			...
			int sizeList = DataStore.getInstance().getAEClist().size();
			if(sizeList>aecKey+1){
