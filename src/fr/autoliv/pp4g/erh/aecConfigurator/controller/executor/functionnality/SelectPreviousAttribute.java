...
@details
	An action of the command pattern : Select the previous attribute
 */
...
public class SelectPreviousAttribute implements ICommand{
	...
	public void execute() {
		try{
			...
			int currentNum=DataStore.getInstance().getAECattributeKey();
			if(currentNum > 0){
