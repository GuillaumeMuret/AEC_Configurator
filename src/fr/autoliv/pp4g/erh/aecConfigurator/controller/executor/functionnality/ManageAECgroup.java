...
@details
	An action of the command pattern : Manage the AEC group
 */
...
public class ManageAECgroup implements ICommand{

	@Override
	public void execute() {
		DialogStore.getInstance().displayManageAECgroupDialog();
	}
