...
public class GenerationARXMLpathPanel extends JPanel implements MouseListener {
	 ...
	 * @param listLabel
	 */
	public GenerationARXMLpathPanel(){
		super();
	...
	public void mousePressed(MouseEvent e) {
		ControlStore.getInstance().getExecutor().executeCommand(IDCommand.DISPLAY_GEN_PATH_ARXML);
	}
