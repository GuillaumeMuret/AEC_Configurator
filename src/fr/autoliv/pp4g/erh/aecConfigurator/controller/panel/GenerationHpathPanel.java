...
public class GenerationHpathPanel extends JPanel implements MouseListener {
	...
	public void mousePressed(MouseEvent e) {
		ControlStore.getInstance().getExecutor().executeCommand(IDCommand.DISPLAY_GEN_PATH_H);
	}
